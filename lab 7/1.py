...
clock_img = pygame.image.load(r"C:\Users\calup\OneDrive\Рабочий стол\TSISS 1\lab7\src\main-clock.png")
screen.blit(clock_img, (0, 0))


image_sec = pygame.image.load(r"C:\Users\calup\OneDrive\Рабочий стол\TSISS 1\lab7\src\left-hand.png").convert_alpha()
image_sec = pygame.transform.rotate(image_sec, 90)
image_min = pygame.image.load(r"C:\Users\calup\OneDrive\Рабочий стол\TSISS 1\lab7\src\right-hand.png").convert_alpha()
